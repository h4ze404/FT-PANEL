================================================================
  AFB-Pack — мод авто-рыбалки + панель управления
================================================================

СОСТАВ
------
MinecraftManager\  — веб-панель управления (localhost:8123)
mods\              — 3 jar-файла для папки mods Minecraft
mod-src\AFBaritone — исходники мода (нужны только для доработки)
